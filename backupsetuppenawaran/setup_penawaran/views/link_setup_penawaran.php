            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card responsive">
                        ...
                        <td> 
                            <?php echo "<input type='text' name='kebutuhan[]' class='form-control'  value='1' id='kebutuhan_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$value->nama_pricelist))."_".$value->id_komp_biaya."' >"; ?> 
                        </td>
                        <td>
                       <?php echo $value->nama_satuan; ?> 
                        ...
                        <td> 
                            <?php echo "<input type='text' name='kebutuhan[]' class='form-control'  value='1' id='kebutuhan_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$values->nama_pricelist))."_".$values->id."' >"; ?> 
                        </td>
                        <td>
                       <?php echo $values->nama_satuan; ?> 
                        </td>
                        <td> <?php echo "Rp. ".number_format($values->harga)."<input type='hidden' name='harga[]' value=".$values->harga.">"; ?>  </td>
                         <td>   <?php echo "<input type='text' name='volume[]' class='form-control'   value='0' id='volume_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$values->nama_pricelist))."_".$values->id."' >"; ?> </td>
                                                </tr>
                                                <?php
                                                }
                                                ?>
                        ...
                        <td> 
                            <?php echo "<input type='text' name='kebutuhan[]' class='form-control'  value='1' id='kebutuhan_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$valuez->nama_pricelist))."_".$valuez->id."' >"; ?> 
                        </td>
                        <td>
                       <?php echo $valuez->nama_satuan; ?> 
                        </td>
                        <td> <?php echo "Rp. ".number_format($valuez->harga)."<input type='hidden' name='harga[]' value=".$valuez->harga.">"; ?>  </td>
                         <td>   <?php echo "<input type='text' name='volume[]' class='form-control'   value='0' id='volume_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$valuez->nama_pricelist))."_".$valuez->id."' >"; ?> </td>
                                                </tr>
                                                <?php
                                                }
                                                ?>
                        ...
                        <td> 
                            <?php echo "<input type='text' name='kebutuhan[]' class='form-control'  value='1' id='kebutuhan_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$valuec->nama_pricelist))."_".$valuec->id."' >"; ?> 
                        </td>
                        <td>
                       <?php echo $valuec->nama_satuan; ?> 
                        </td>
                        <td> <?php echo "Rp. ".number_format($valuec->harga)."<input type='hidden' name='harga[]' value=".$valuec->harga.">"; ?>  </td>
                         <td>   <?php echo "<input type='text' name='volume[]' class='form-control'   value='0' id='volume_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$valuec->nama_pricelist))."_".$valuec->id."' >"; ?> </td>
                                                </tr>
                                                <?php
                                                }
                                                ?>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="umum">
                                     <form method="post" id="user_form_umum" enctype="multipart/form-data">  
                                      ...
                                      <input type="hidden" name="tahap_umum" id="tahap_umum">
                                    <table class="table table-responsive table-bordered table-hovered">
                                            <thead>
                                                <tr>
                                                    <th style="width: 10%;">Komponen Biaya</th>
                         ...
                         <td>
                            <?php echo $valuev->nama_pricelist."<input type='hidden' name='id_pricelist[]' value=".$valuev->id."> <input type='hidden' name='id_pelayanan[]' value=".$valuev->id_pelayanan."> "; ?>
                            
                        </td> 
                        <td> 
                            <?php echo "<input type='text' name='kebutuhan[]' class='form-control'  value='1' id='kebutuhan_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$valuev->nama_pricelist))."_".$valuev->id."' >"; ?> 
                        </td>
                        <td>
                       <?php echo $valuev->nama_satuan; ?> 
                        </td>
                        <td> <?php echo "Rp. ".number_format($valuev->harga)."<input type='hidden' name='harga[]' value=".$valuev->harga.">"; ?>  </td>
