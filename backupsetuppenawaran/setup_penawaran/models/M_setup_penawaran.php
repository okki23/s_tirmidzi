...
class M_setup_penawaran extends Parent_Model { 
  ...
  public function fetch_harga(){
       ...
       $getdata = $this->db->get('m_harga')->result();
       $data = array();  
  ...
  public function fetch_setup_penawaran(){
      ...
      public function fetch_setup_penawaran_parent(){
      
       $sql = "select a.*,b.nama_komp_biaya,c.nama_pelayanan,d.nama_satuan from m_setup_penawaran a
