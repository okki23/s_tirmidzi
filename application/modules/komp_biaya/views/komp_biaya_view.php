							   ...
							   <table class="table table-bordered table-striped table-hover js-basic-example" id="example" >
									...
									<thead>
										<tr>
                                            ...
                                            <th style="width:10%;">Nama Komponen Pembiayaan</th>
                              ...
                              <form method="post" id="user_form" enctype="multipart/form-data">   
									...
									<div class="input-group">
                                                <div class="form-line">
                                                    ...
                                                    <input type="hidden" name="id_jenis_layanan" id="id_jenis_layanan" required>
									...
									<div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nama_komp_biaya" id="nama_komp_biaya" class="form-control" placeholder="Nama Komponen Pembiayaan" />
                                        </div>
                                    </div>
   ...
   <script type="text/javascript">
    ...
    function CariPelayanan(){
        ...
        $('#daftar_pelayanan tbody').on('click', 'tr', function () {
            ...
            $("#id_jenis_layanan").val(content[1]);
	 ...
	 function Ubah_Data(id){
		...
		$.ajax({
			 url:"<?php echo base_url(); ?>komp_biaya/get_data_edit/"+id,
			 type:"GET",
			 dataType:"JSON", 
			 success:function(result){ 
                 ...
                 $("#id_jenis_layanan").val(result.id_jenis_layanan); 
	 ...
	 function Hapus_Data(id){
        ...
        $.ajax({
            url : "<?php echo base_url('komp_biaya/hapus_data')?>/"+id,
            type: "GET",
            dataType: "JSON",
	...
	function Simpan_Data(){
		//setting semua data dalam form dijadikan 1 variabel 
         ...
         var nama_komp_biaya = $("#nama_komp_biaya").val(); 
            //transaksi dibelakang layar
            $.ajax({
             url:"<?php echo base_url(); ?>komp_biaya/simpan_data",
             type:"POST",
             data:formData,
             contentType:false,  
             processData:false,   
       ...
       $(document).ready(function() {
		...
		$('#example').DataTable( {
			"ajax": "<?php echo base_url(); ?>komp_biaya/fetch_komp_biaya" ,
               'rowsGroup': [1] ,
            'order': [[ 0, 'asc' ]]
		});
