                ...
                <div class="col-lg-12">
                    <div class="card responsive">
                        ...
                        <div class="body">
                             ...
                             Pilih Tahap : 
                              <select name="id_tahapx" id="id_tahapx" >
                              <option value="">--Pilih--</option>
                              <?php
                                for ($i=1; $i<=$tahap->tahap; $i++) { 
                                ...
                                <div role="tabpanel" class="tab-pane fade in active" id="pra_ops">
                                   <form method="post" id="user_form_praops" enctype="multipart/form-data">  
                                     ...
                                     <input type="hidden" name="id_penawaranx" id="id_penawaranx" value="<?php echo $this->uri->segment(3); ?>">
                                      <input type="hidden" name="tahapx" id="tahapx">
                        ...
                        <td>
                            <?php echo $value->nama_pricelist."<input type='hidden' name='id_pricelist[]' value=".$value->id."> <input type='hidden' name='id_pelayanan[]' value=".$value->id_pelayanan."> "; ?>
                            
                        </td> 
                        <td> 
                            <?php echo "<input type='text' name='kebutuhan[]' class='form-control'  value='0' id='kebutuhan_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$value->nama_pricelist))."_".$value->id_komp_biaya."' >"; ?> 
                        </td>
                        <td>
                       <?php echo $value->nama_satuan; ?> 
                        </td>
                        <td> <?php echo "Rp. ".number_format($value->harga)."<input type='hidden' name='harga[]' value=".$value->harga.">"; ?>  </td>
                         <td>   <?php echo "<input type='text' name='volume[]' class='form-control'   value='1' id='volume_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$value->nama_pricelist))."_".$value->id_komp_biaya."' >"; ?> </td>
                                                </tr>
                                                <?php
                                                }
                                                ?>
                                        ...
                                        <br>
                                         <table>
                                    <tr>
                                        <td>  <button type="button" id="simpan_data_praops_btn" onclick="Simpan_Data_Praops();" class="btn btn-success waves-effect"> <i class="material-icons">save</i> Simpan Data</button> &nbsp; </td>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="yan_trans">
                                  <form method="post" id="user_form_yantrans" enctype="multipart/form-data">  
                                     ...
                                     <input type="hidden" name="id_penawaran_trans" id="id_penawaran_trans" value="<?php echo $this->uri->segment(3); ?>">
                                      <input type="hidden" name="tahap_trans" id="tahap_trans">
                        ...
                        <td>
                            <?php echo $values->nama_pricelist."<input type='hidden' name='id_pricelist[]' value=".$values->id."> <input type='hidden' name='id_pelayanan[]' value=".$values->id_pelayanan."> "; ?>
                            
                        </td> 
                        <td> 
                            <?php echo "<input type='text' name='kebutuhan[]' class='form-control'  value='0' id='kebutuhan_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$values->nama_pricelist))."_".$values->id."' >"; ?> 
                        </td>
                        <td>
                       <?php echo $values->nama_satuan; ?> 
                        </td>
                        <td> <?php echo "Rp. ".number_format($values->harga)."<input type='hidden' name='harga[]' value=".$values->harga.">"; ?>  </td>
                         <td>   <?php echo "<input type='text' name='volume[]' class='form-control'   value='1' id='volume_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$values->nama_pricelist))."_".$values->id."' >"; ?> </td>
                                                </tr>
                                                <?php
                                                }
                                                ?>
                                    ...
                                    <tr>
                                        <td>  <button type="button" id="simpan_data_yantrans_btn" onclick="Simpan_Data_YanTrans();" class="btn btn-success waves-effect"> <i class="material-icons">save</i> Simpan Data </button> &nbsp; </td>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="yan_lalin">
                                     <form method="post" id="user_form_yanlalin" enctype="multipart/form-data">  
                                      ...
                                      <input type="hidden" name="tahap_lalin" id="tahap_lalin">
                                     <table class="table table-responsive table-bordered table-hovered">
                                            <thead>
                                                <tr>
                                                    <th style="width: 10%;">Komponen Biaya</th>
                        ...
                        <td>
                            <?php echo $valuez->nama_pricelist."<input type='hidden' name='id_pricelist[]' value=".$valuez->id."> <input type='hidden' name='id_pelayanan[]' value=".$valuez->id_pelayanan."> "; ?>
                            
                        </td> 
                        <td> 
                            <?php echo "<input type='text' name='kebutuhan[]' class='form-control'  value='0' id='kebutuhan_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$valuez->nama_pricelist))."_".$valuez->id."' >"; ?> 
                        </td>
                        <td>
                       <?php echo $valuez->nama_satuan; ?> 
                        </td>
                        <td> <?php echo "Rp. ".number_format($valuez->harga)."<input type='hidden' name='harga[]' value=".$valuez->harga.">"; ?>  </td>
                         <td>   <?php echo "<input type='text' name='volume[]' class='form-control'   value='1' id='volume_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$valuez->nama_pricelist))."_".$valuez->id."' >"; ?> </td>
                                                </tr>
                                                <?php
                                                }
                                                ?>
                                        ...
                                        <br>
                                         <table>
                                    <tr>
                                        <td>  <button type="button" id="simpan_data_lalin_btn" onclick="Simpan_Data_Lalin();" class="btn btn-success waves-effect"> <i class="material-icons">save</i> Simpan Data</button> &nbsp; </td>
                                        <td> &nbsp; <button type="button"  id="calc_data_lalin_btn"  onclick="Calculate_YanLalin();" class="btn btn-success waves-effect"> <i class="material-icons">save</i> Calculate</button> </td>
                                    </tr>
                                </table>

                                </div>
                                <div role="tabpanel" class="tab-pane fade" id="yan_pml">
                                     <form method="post" id="user_form_yanpml" enctype="multipart/form-data">  

                                       <input type="hidden" name="id_penawaran_yanpml" id="id_penawaran_yanpml" value="<?php echo $this->uri->segment(3); ?>">
                                      <input type="hidden" name="tahap_pml" id="tahap_pml">
                                     <table class="table table-responsive table-bordered table-hovered">
                                            <thead>
                                                <tr>
                                                    <th style="width: 10%;">Komponen Biaya</th>
                        ...
                        <td>
                            <?php echo $valuec->nama_pricelist."<input type='hidden' name='id_pricelist[]' value=".$valuec->id."> <input type='hidden' name='id_pelayanan[]' value=".$valuec->id_pelayanan."> "; ?>
                            
                        </td> 
                        <td> 
                            <?php echo "<input type='text' name='kebutuhan[]' class='form-control'  value='0' id='kebutuhan_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$valuec->nama_pricelist))."_".$valuec->id."' >"; ?> 
                        </td>
                        <td>
                       <?php echo $valuec->nama_satuan; ?> 
                        </td>
                        <td> <?php echo "Rp. ".number_format($valuec->harga)."<input type='hidden' name='harga[]' value=".$valuec->harga.">"; ?>  </td>
                         <td>   <?php echo "<input type='text' name='volume[]' class='form-control'   value='1' id='volume_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$valuec->nama_pricelist))."_".$valuec->id."' >"; ?> </td>
                                                </tr>
                                                <?php
                                                }
                                                ?>
                                         ...
                                         <table>
                                    <tr>
                                        <td>  <button type="button" onclick="Simpan_Data_Pml();" id="simpan_data_pml_btn" class="btn btn-success waves-effect"> <i class="material-icons">save</i> Simpan Data</button> &nbsp; </td>
                                        <td> &nbsp; <button type="button" id="calc_data_pml_btn"  onclick="Calculate_Pml();" class="btn btn-success waves-effect"> <i class="material-icons">save</i> Calculate</button> </td>
                                    </tr>
                                </table>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="umum">
                                     <form method="post" id="user_form_umum" enctype="multipart/form-data">  
                                       ...
                                       <input type="text" name="id_penawaran_umum" id="id_penawaran_umum" value="<?php echo $this->uri->segment(3); ?>">
                                      <input type="text" name="tahap_umum" id="tahap_umum">
                                    <table class="table table-responsive table-bordered table-hovered">
                                            <thead>
                                                <tr>
                                                    <th style="width: 10%;">Komponen Biaya</th>
                         ...
                         <td>
                            <?php echo $valuev->nama_pricelist."<input type='text' name='id_pricelist[]' value=".$valuev->id."> <input type='hidden' name='id_pelayanan[]' value=".$valuev->id_pelayanan."> "; ?>
                            
                        </td> 
                        <td> 
                            <?php echo "<input type='text' name='kebutuhan[]' class='form-control'  value='0' id='kebutuhan_".strtolower(str_replace(array(" ","/","-",".","(",")","+",":",",","'"),"",$valuev->nama_pricelist))."_".$valuev->id."' >"; ?> 
                        </td>
                        <td>
                       <?php echo $valuev->nama_satuan; ?> 
                        </td>
                        <td> <?php echo "Rp. ".number_format($valuev->harga)."<input type='text' name='harga[]' value=".$valuev->harga.">"; ?>  </td>
                         <td>   <?php echo "<input type='text' name='volume[]' class='form-control'   value='1' id='volume_".strtolower(str_replace(array(" ","@","/","-",".","(",")","+",":",",","'"),"",$valuev->nama_pricelist))."_".$valuev->id."' >"; ?> </td>
                                                </tr>
                                                <?php
                                                }
                                                ?>
                                    ...
                                    <tr>
                                        <td>  <button type="button" id="simpan_data_umum_btn" onclick="Simpan_Data_Umum();" class="btn btn-success waves-effect"> <i class="material-icons">save</i> Simpan Data</button> &nbsp; </td>
                                        <td> &nbsp; <button type="button" id="calc_data_umum_btn" onclick="Calculate_Umum();" class="btn btn-success waves-effect"> <i class="material-icons">save</i> Calculate</button> </td>
                                    </tr>
                                </table>
                                </div>
                            </div>
...
<script type="text/javascript">
   ...
   function Simpan_Data_Umum(){
        ...
        if(confirm('Anda yakin ingin menyimpan data ini? pastikan kalkulasi telah dilakukan !')){
          $("#simpan_data_umum_btn").prop("disabled",true);
          $("#calc_data_umum_btn").prop("disabled",true);
         
             $.ajax({
             url:"<?php echo base_url(); ?>setup_penawaran/simpan_data_umum",
             type:"POST",
             data:$("#user_form_umum").serialize(),
             beforeSend: function(){
                   $("#loading_umum").show();
                    $("#msg_umum_form").html("");
                 },
                 complete: function(){
                   $("#loading_umum").hide();
                    $("#msg_umum_form").html("Data sudah di simpan!");
                 },
   ...
   function Simpan_Data_Praops(){
        
        if(confirm('Anda yakin ingin menyimpan data ini? pastikan kalkulasi telah dilakukan !')){
          $("#simpan_data_praops_btn").prop("disabled",true);
          $("#calc_data_praops_btn").prop("disabled",true);
          //var tes = $("#user_form_praops").serialize();
          //console.log(tes);
         
             $.ajax({
             url:"<?php echo base_url(); ?>setup_penawaran/simpan_data_praops",
             type:"POST",
             data:$("#user_form_praops").serialize(),
             beforeSend: function(){
                   $("#loading_praops").show();
                 ...
                 complete: function(){
                   $("#loading_praops").hide();
                    $("#msg_praops_form").html("Data sudah di simpan!");
                 },
             success:function(result){
             window.opener.location.reload()
    ...
    function Simpan_Data_Pml(){
        
        if(confirm('Anda yakin ingin menyimpan data ini? pastikan kalkulasi telah dilakukan !')){
          $("#simpan_data_pml_btn").prop("disabled",true);
          $("#calc_data_pml_btn").prop("disabled",true);
          //var tes = $("#user_form_praops").serialize();
          //console.log(tes);
         
             $.ajax({
             url:"<?php echo base_url(); ?>setup_penawaran/simpan_data_pml",
             type:"POST",
             data:$("#user_form_yanpml").serialize(),
             beforeSend: function(){
                   $("#loading_yanpml").show();
                 ...
                 complete: function(){
                   $("#loading_yanpml").hide();
                    $("#msg_yanpml_form").html("Data sudah di simpan!");
                 },
             success:function(result){
             window.opener.location.reload()
    ...
    function Simpan_Data_YanTrans(){
  
        if(confirm('Anda yakin ingin menyimpan data ini? pastikan kalkulasi telah dilakukan !')){
          $("#simpan_data_yantrans_btn").prop("disabled",true);
          $("#calc_data_yantrans_btn").prop("disabled",true);
          //var tes = $("#user_form_praops").serialize();
          //console.log(tes);
          
             $.ajax({
             url:"<?php echo base_url(); ?>setup_penawaran/simpan_data_yantrans",
             type:"POST",
             data:$("#user_form_yantrans").serialize(),
             beforeSend: function(){
                 ...
                 complete: function(){
                   $("#loading_yantrans").hide();
                    $("#msg_yantrans_form").html("Data sudah di simpan!");
                 },
             success:function(result){
             window.opener.location.reload()
   ...
   function Simpan_Data_Lalin(){
        
        if(confirm('Anda yakin ingin menyimpan data ini? pastikan kalkulasi telah dilakukan !')){
          $("#simpan_data_lalin_btn").prop("disabled",true);
          $("#calc_data_lalin_btn").prop("disabled",true);
          //var tes = $("#user_form_praops").serialize();
          //console.log(tes);
         
             $.ajax({
             url:"<?php echo base_url(); ?>setup_penawaran/simpan_data_yanlalin",
             type:"POST",
             data:$("#user_form_yanlalin").serialize(),
             beforeSend: function(){
                 ...
                 complete: function(){
                   $("#loading_yanlalin").hide();
                    $("#msg_yanlalin_form").html("Data sudah di simpan!");
                 },
             success:function(result){
             window.opener.location.reload()
